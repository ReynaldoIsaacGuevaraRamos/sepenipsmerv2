    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; SEPENIPSMER 2021</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
    ...
    <!--datepicker CSS básico-->
    <link rel="stylesheet" type="text/css" href="../assets/bootstrap-datepicker/css/bootstrap-datepicker.css" />
    <!--Importar JS del CRUD administradores-->
    <script type="text/javascript" src="mainEmpleados.js"></script>
    <!--Importar JS del CRUD Usuarios-->
    <script type="text/javascript" src="mainAdministradores.js"></script>
    <!--Importar JS del CRUD Empleados-->

    <script type="text/javascript" src="mainUsuarios.js"></script>
      <!--Importar JS del CRUD Evaluar-->
